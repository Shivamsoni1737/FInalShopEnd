...
const Header = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const { message, isAuthenticated, merchant } = useSelector(
    (state) => state.user
  );
      ...
      <div className='relative py-3 px-3 font-semibold sm:px-5 h-16 flex flex-row items-center justify-between  m-auto nav_container'>
        {location.pathname === "/dashboard" ? (
          <div
            ...
            className='hamburger w-7 ml-2 md:hidden cursor-pointer'
          >
        ...
        <div>
          <div
            className={`nav_dropLinks ${
              active && !isAuthenticated ? "show" : "hide"
            } `}
          >
            <div className='absolute top-20 left-0 right-0 w-full px-2 rounded-b-md'>
              <ul className='bg-gray-200 flex flex-col items-center text-lg rounded-md transition-all'>
                <li className='p-1 cursor-pointer hover:text-black'>
                  <a href='/our-mission' className='hover:text-black'>
                    Our mission
                  </a>
                </li>
                <li className='p-1 cursor-pointer hover:text-black'>
                ...
                <li className='p-1 cursor-pointer hover:text-black'>
                  <a href='/why-us' className='hover:text-black'>
                    Why us?
                  </a>
                </li>
              </ul>
          ...
          <div className='nav_horizontalLinks'>
            {isAuthenticated ? (
              ...
              <ul className='flex gap-4'>
                <li className='cursor-pointer hover:text-black hover:underline hover:underline-offset-4'>
                  <a href='/home/our-mission' className='hover:text-black'>
                    Our mission
                  </a>
                </li>
                <li className='cursor-pointer hover:text-black hover:underline hover:underline-offset-4'>
                  <a href='/home/about-us' className='hover:text-black'>
                    About us
                  </a>
                </li>
                <li className='cursor-pointer hover:text-black hover:underline hover:underline-offset-4'>
                  <a href='/home/our-services' className='hover:text-black'>
                    Our services
                  </a>
                </li>
                <li className='cursor-pointer hover:text-black hover:underline hover:underline-offset-4'>
                  <a href='/home/why-us' className='hover:text-black'>
                    Why us?
                  </a>
                </li>
              </ul>
        ...
        <div className='flex items-center gap-2'>
          {
            ...
            isAuthenticated ? (
              <div className='flex relative items-center text-gray-600 gap-2'>
                ...
                {open && (
                  <div className='bg-white absolute right-4 shadow-lg top-8 w-[153px] rounded-lg py-1'>
                    ...
                    >
                      <MdOutlineSpaceDashboard className='h-6 mr-2' /> Dashboard
                    </div>
                    <div
                      onClick={() => {
                      ...
                      className='flex flex-row px-3 py-1 text-gray-600 hover:text-black hover:bg-gray-100 hover:cursor-pointer'
                    >
                      <ImProfile className='h-6 mr-2' /> Profile
                    </div>
                    <div
                      onClick={() => {
                      ...
                      className='flex flex-row px-3 py-1 text-gray-600 hover:text-black hover:bg-gray-100 hover:cursor-pointer'
                    >
                      <FiSettings className='h-6 mr-2' /> Settings
                    </div>
                    <div
                      onClick={() => {
                        setOpen(!open);
                      ...
                      className='flex flex-row px-3 py-1 text-gray-600 hover:text-black hover:bg-gray-100 hover:cursor-pointer'
                    >
                      <MdLogout className='h-6 mr-2' /> Sign out
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className='flex items-center gap-3'>
                <Link to='/home/login'>
                  <li className='mt-2 flex gap-2 items-center hover:text-black cursor-pointer'>
                    <span>Login</span>
                  </li>
                </Link>
                <Link to='//home/signup'>
                  <li className='mt-2 flex gap-2 border border-gray-400 rounded-md p-2 items-center hover:border-black hover:text-black cursor-pointer'>
                    <span>Sign up</span>
                  </li>
                </Link>
              </div>
