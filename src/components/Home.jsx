      ...
      <div className='flex static top-20 flex-wrap gap-4'>
        <p
          ...
          className={`border rounded-lg ${
            dist == -1 ? "bg-blue-300" : ""
          } border-blue-700 hover:bg-blue-300 hover:cursor-pointer transition-all duration-200 shadow-md px-3 py-1`}
        >
          All shops
        </p>
        <p
        ...
        {allShops &&
          allShops.map((shop) => (
            ...
            >
              ...
              />
              <div
                className={`absolute bottom-0 bg-white w-full px-1 text-center py-2 rounded-b-md`}
              >
