      ...
      <footer className='flex justify-center flex-col  text-center bg-gray-100 py-6'>
        <div className='flex flex-col md:justify-between md:flex-row items-center py-8 md:px-32'>
          <div className='flex flex-col md:items-start'>
            ...
            <a href='/terms' target='_blank' rel='noreferrer' className='my-1'>
          ...
          <div>
            ...
            <div className='flex justify-center my-2'>
              <a
                href='https://www.linkedin.com/company/shoffline'
                target='_blank'
                rel='noreferrer'
                className='border-2 border-gray-200 rounded-full p-3 mx-1 hover:bg-green-600 hover:text-white'
              >
                <FaLinkedinIn />
              </a>
              <a
                href='https://www.instagram.com/shofflineindia/'
                target='_blank'
                rel='noreferrer'
                className='border-2 border-gray-200 rounded-full p-3 mx-1 hover:bg-green-600 hover:text-white'
              >
        ...
        <p className='my-4 md:my-0'>©Shoffline all rights reserved</p>
      </footer>
    );
  }
};
