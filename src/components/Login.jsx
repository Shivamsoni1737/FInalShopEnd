        ...
        <div className='w-full flex flex-col md:flex-row min-h-[80vh] items-center justify-center flex-1 text-center '>
          <div className='w-full py-8 md:w-3/5'>
            <div className='items-center flex flex-col justify-center'>
              ...
              <button
                onClick={handleLogin}
                className='border border-[#003979] font-semibold rounded-lg mb-8 px-12 py-2 text-black hover:shadow-lg flex items-center'
              >
          ...
          <div className='w-full md:w-2/5 bg-green-800 text-white px-12 py-36'>
            {" "}
            {/* signup Section */}
            ...
            <Link
              to='/signup'
              className='border-2 border-white font-semibold rounded-full px-12 py-2 inline-block hover:bg-white hover:text-green-800'
            >
              Signup
            </Link>
          </div>
